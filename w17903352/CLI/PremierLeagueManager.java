...
public class PremierLeagueManager implements LeagueManager {
	...
	public void saveData() {
		...
		try {
			...
			objOut.writeObject(listOfSportsClubs);
			objOut.writeObject(listOfMatches );
	...
	public void loadData() {
		try {
			...
			listOfSportsClubs  = (ArrayList) objOutput.readObject();
			listOfMatches  = (ArrayList) objOutput.readObject();
